...
async def create_indexes():
    try:
        ...
        await db["processes"].create_index("metrics")
        await db["processes"].create_index("metrics.timestamp")
        await db["processes"].create_index("metrics.cpu")
        await db["processes"].create_index("metrics.memory")
